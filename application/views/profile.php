                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="<?php echo base_url() ?>assets/dist/img/woi.jpg" alt="Admin" class="rounded-circle" width="150">
                                <div class="mt-3">
                                    <h4>Muhammad Denny Setiawan</h4>
                                    <p class="text-secondary mb-1">Pengangguran</p>
                                    <p class="text-muted font-size-sm">Ciledug, Tangerang </p>
